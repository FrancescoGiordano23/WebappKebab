...
<script>
    document.addEventListener('DOMContentLoaded', function() {
    	document.getElementById('CreateKebabForm').addEventListener('submit', function(event) {
...
<script type="text/javascript">
        ...
        function resetTimer() {
            ...
            inactivityTimeout = setTimeout(redirectToTimeoutPage, 5 * 60 * 1000); // 5 minutes
        }

        function redirectToTimeoutPage() {
            window.location.href = 'login.jsp'; // Redirect to your session timeout page
        }
					...
					<div class="container">
						...
						<div class="overflow-x-hidden overflow-y-auto"
							...
							<div class="row align-items-start">
								...
								<div class="col border" style="height: 51px"><%=k.getContainer().getName()%></div>
								<div class="col border" style="height: 51px"><%=k.getPrimaryIngredient().getName()%></div>
